...
** New functions: *viewalias*, *remark*, *order*
** Modifications to existing functions: adding of a birthday field to *add*
** Enhancements for the user interface: new pop-up window to view default commands and their custom set alias(coming in v1.2)
