...
|`* *` |user |drag and drop contacts in or out of different groups |not need to key in complex command lines

|`* *` |user |view groups of contacts in a more visual display |see who are also in the group

|`* *` |user |view groups of contacts in a more visual display |look for a contact in the group easily
