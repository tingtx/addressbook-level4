...
TunedIn using Commands, which can be keyed in in the command field. We have a variety of commands on TunedIn, we have
listed all of them, and how they are used below. We are constantly striving to expand this list of commands, feel free
...
=== Set theme : `settheme` - Coming in V1.4
